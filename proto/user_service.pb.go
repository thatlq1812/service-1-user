...
const file_proto_user_service_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user_service.proto\x12\x04user\"_\n" +
	"\x04User\x12\x0e\n" +
	...
	".user.User\x12<\n" +
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB\x16Z\x14service-1-user/protob\x06proto3"
